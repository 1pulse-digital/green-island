...
export const About = () => {
  return (
    <div
      className={"grid h-full md:h-[700px] w-full content-center bg-gray-50"}>
      <div className={"grid grid-cols-1 md:grid-cols-2 "}>
        ...
        <div
          className={
            " grid content-center font-karla p-5 sm:p-10 md:max-w-prose "
          }>
          <h1
            className={
          ...
          <p
            ...
            It is capable of self-healing. To access this power ​you must remove
            the obstacles in its way and provide the tools it needs for the job.
          </p>
          <p
            className={
