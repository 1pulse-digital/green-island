...
export const TestimonialCarousel = () => {
  ...
  return (
    <div className="  grid grid-cols-1 py-10 sm:h-  md:grid-cols-1 md:px-32 lg:grid-cols-1 xl:grid-cols-1  ">
      <h1
        className={
          " sm:px-10 text-4xl   md:text-4xl  z-10 text-white font-medium font-karla pb-12 "
        }>
      ...
      >
        <div className={"grid mb-20 "}>
          <p
            className={
              "italic md:text-2xl sm:text-xl  text-white font-light  "
            }>
        ...
        <div className={"grid"}>
          <p className={"italic md:text-2xl sm:text-xl text-white font-light "}>
